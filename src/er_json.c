...
static er_json_node * er_json_node_new_object(const char * location)
{
    ...
    obj->value.object = cx_map_new(_string_key_compare, cpl_free,
                                              ...
                                              const char * location)
{
    ...
    obj->value.string = cpl_strdup(string);
    obj->location = location;
    return obj;
}
...
void er_json_node_delete(er_json_node * obj)
{
    ...
    switch (obj->type)
    {
        ...
        case JSON_BOOL:
            ...
            break;
        case JSON_OBJECT:
            cx_map_delete(obj->value.object);
            break;
        case JSON_ARRAY:
            cx_list_destroy(obj->value.array,
                            (cx_free_func)er_json_node_delete);
            break;
        case JSON_STRING:
            cpl_free(obj->value.string);
            break;
        default:
            assert(
                obj->type == JSON_NULL ||
...
cpl_size er_json_node_array_size(const er_json_node * obj)
{
    ...
    return cx_list_size(obj->value.array);
}
...
cpl_boolean er_json_node_array_empty(const er_json_node * obj)
{
    ...
    return cx_list_empty(obj->value.array);
}
...
er_json_array_iterator er_json_node_array_begin(const er_json_node * obj)
{
    ...
    return cx_list_begin(obj->value.array);
}
...
er_json_array_iterator er_json_node_array_end(const er_json_node * obj)
{
    ...
    cpl_error_ensure(obj->type == JSON_ARRAY, CPL_ERROR_ILLEGAL_INPUT,
                     return NULL, "JSON node is not an array.");
    return cx_list_end(obj->value.array);
}
                                               ...
                                               er_json_array_iterator current)
{
    ...
    cpl_error_ensure(obj->type == JSON_ARRAY, CPL_ERROR_ILLEGAL_INPUT,
                     return NULL, "JSON node is not an array.");
    return cx_list_next(obj->value.array, current);
}
                                                ...
                                                er_json_array_iterator current)
{
    ...
    cpl_error_ensure(obj->type == JSON_ARRAY, CPL_ERROR_ILLEGAL_INPUT,
                     return NULL, "JSON node is not an array.");
    return cx_list_previous(obj->value.array, current);
}
                                            ...
                                            er_json_array_iterator iterator)
{
    ...
    cpl_error_ensure(obj->type == JSON_ARRAY, CPL_ERROR_ILLEGAL_INPUT,
                     return NULL, "JSON node is not an array.");
    return (er_json_node *) cx_list_get(obj->value.array, iterator);
}
...
static void er_json_node_array_append(er_json_node * obj, er_json_node * value)
{
    ...
    cx_list_push_back(obj->value.array, value);
}
...
cpl_size er_json_node_object_size(const er_json_node * obj)
{
    ...
    return cx_map_size(obj->value.object);
}
...
cpl_boolean er_json_node_object_empty(const er_json_node * obj)
{
    ...
    return cx_map_empty(obj->value.object);
}
...
er_json_object_iterator er_json_node_object_begin(const er_json_node * obj)
{
    ...
    return cx_map_begin(obj->value.object);
}
...
er_json_object_iterator er_json_node_object_end(const er_json_node * obj)
{
    ...
    cpl_error_ensure(obj->type == JSON_OBJECT, CPL_ERROR_ILLEGAL_INPUT,
                     return NULL, "JSON node is not an object.");
    return cx_map_end(obj->value.object);
}
                                            ...
                                            er_json_object_iterator current)
{
    ...
    cpl_error_ensure(obj->type == JSON_OBJECT, CPL_ERROR_ILLEGAL_INPUT,
                     return NULL, "JSON node is not an object.");
    return cx_map_next(obj->value.object, current);
}
                                            ...
                                            er_json_object_iterator current)
{
    ...
    cpl_error_ensure(obj->type == JSON_OBJECT, CPL_ERROR_ILLEGAL_INPUT,
                     return NULL, "JSON node is not an object.");
    return cx_map_previous(obj->value.object, current);
}
                                         ...
                                         er_json_object_iterator iterator)
{
    ...
    cpl_error_ensure(obj->type == JSON_OBJECT, CPL_ERROR_ILLEGAL_INPUT,
                     return NULL, "JSON node is not an object.");
    return (const char *) cx_map_get_key(obj->value.object, iterator);
}
                                            ...
                                            er_json_object_iterator iterator)
{
    ...
    cpl_error_ensure(obj->type == JSON_OBJECT, CPL_ERROR_ILLEGAL_INPUT,
                     return NULL, "JSON node is not an object.");
    return (er_json_node *) cx_map_get_value(obj->value.object, iterator);
}
                                             ...
                                             const char * key)
{
    ...
    cpl_error_ensure(obj->type == JSON_OBJECT, CPL_ERROR_ILLEGAL_INPUT,
                     return NULL, "JSON node is not an object.");
    er_json_object_iterator item = cx_map_find(obj->value.object, key);
    if (item != cx_map_end(obj->value.object))
    {
        return (er_json_node *) cx_map_get_value(obj->value.object, item);
    }
    else
    {
        return NULL;
                                       ...
                                       const char * key, er_json_node * value)
{
    ...
    cx_map_insert(obj->value.object, cpl_strdup(key), value);
}
